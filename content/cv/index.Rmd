...
robust, accurate and efficient models.
...
* Delivered an American Football simulation model used to price all betbuilder bets.
...
* Reimplemented existing model MATLAB scripts into an object orientated 
model architecture to bring the solution to production quality. Added a 
testing framework and a fully featured test harness.
